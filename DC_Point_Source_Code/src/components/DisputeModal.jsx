      ...
      <div className="modal-content" style={{ maxWidth: '840px' }} onClick={e => e.stopPropagation()}>
        <div className="modal-header" style={{ background: '#EF4444', color: '#FFFFFF' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <ShieldAlert size={20} />
            <div>
              <h3 style={{ fontSize: '1.15rem', fontWeight: '800', color: '#FFFFFF' }}>Resolution Center — Raise Grievance</h3>
              <div style={{ fontSize: '0.75rem', opacity: 0.9 }}>AI-Assisted Contract Mediation Workspace</div>
            </div>
          </div>
          ...
          <div className="grid-2" style={{ gap: '1.5rem' }}>
            ...
            <div style={{ background: '#F8FAFC', border: '1px solid #E2E8F0', padding: '1.25rem', borderRadius: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#0B192C', fontWeight: '700', fontSize: '0.9rem', marginBottom: '0.75rem' }}>
                <FileText size={16} /> Signed Contract Terms Reference
              </div>
            ...
            <div>
              <h4 style={{ fontSize: '1rem', fontWeight: '700', marginBottom: '0.75rem' }}>Dispute Claim Details</h4>
              
              <div style={{ marginBottom: '0.85rem' }}>
                <label style={{ fontSize: '0.8rem', fontWeight: '600', display: 'block', marginBottom: '0.25rem' }}>Grievance Category:</label>
                <select 
                  value={disputeReason} 
              ...
              <div style={{ marginBottom: '1rem' }}>
                <label style={{ fontSize: '0.8rem', fontWeight: '600', display: 'block', marginBottom: '0.25rem' }}>Detailed Explanation & Evidence Notes:</label>
                <textarea 
                  rows={3} 
              ...
              <button 
                ...
                style={{ width: '100%', marginBottom: '1rem', color: '#00ADB5', borderColor: '#00ADB5' }}
              ...
              {aiMediation && (
                <div style={{ background: '#EFF6FF', border: '1px solid #93C5FD', padding: '1rem', borderRadius: '10px', fontSize: '0.825rem' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem', color: '#1D4ED8', fontWeight: '700', marginBottom: '0.35rem' }}>
                    <Sparkles size={14} /> AI Recommendation Result:
                  </div>
                  <div style={{ color: '#1E40AF', fontWeight: '600', marginBottom: '0.25rem' }}>{aiMediation.recommendation}</div>
                  <p style={{ color: '#3B82F6', lineHeight: '1.4' }}>{aiMediation.reasoning}</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="modal-footer">
          ...
          <button className="btn-danger" onClick={() => onSubmitDispute({ tradeId: trade.id, disputeReason, description, aiMediation })}>
