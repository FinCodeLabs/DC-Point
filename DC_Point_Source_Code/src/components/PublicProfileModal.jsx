      ...
      <div className="modal-content" style={{ maxWidth: '640px' }} onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <UserCheck size={18} color="#00ADB5" />
            <h3 style={{ fontSize: '1.1rem', fontWeight: '700' }}>Public Merchant Reputation Profile</h3>
          </div>
        ...
        <div className="modal-body">
          <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
            ...
            <div style={{ fontSize: '0.85rem', color: '#64748B', marginTop: '0.2rem' }}>{persona.role}</div>
            <div style={{ marginTop: '0.5rem' }}>
              <span className="badge badge-verified"><ShieldCheck size={12} /> {persona.verifiedStatus}</span>
            </div>
          </div>
          ...
          <div className="grid-3" style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
            <div style={{ background: '#F8FAFC', padding: '1rem', borderRadius: '10px', border: '1px solid #E2E8F0' }}>
              ...
              <div style={{ fontSize: '0.75rem', color: '#64748B' }}>Rating Score</div>
            </div>

            <div style={{ background: '#F8FAFC', padding: '1rem', borderRadius: '10px', border: '1px solid #E2E8F0' }}>
              <div style={{ fontSize: '1.5rem', fontWeight: '800', color: '#0B192C' }}>{persona.completedTrades}</div>
              <div style={{ fontSize: '0.75rem', color: '#64748B' }}>Completed Escrow Trades</div>
            </div>

            <div style={{ background: '#F8FAFC', padding: '1rem', borderRadius: '10px', border: '1px solid #E2E8F0' }}>
              <div style={{ fontSize: '1.5rem', fontWeight: '800', color: '#10B981' }}>{persona.trustScore}%</div>
              <div style={{ fontSize: '0.75rem', color: '#64748B' }}>Trust Index</div>
            </div>
          </div>
        ...
        <div className="modal-footer">
          <button className="btn-navy" onClick={onClose} style={{ width: '100%' }}>
            Close Profile View
          </button>
        </div>
      </div>
